...
template void to_montgomery<P128_1>(FieldElement<P128_1>&, const std::array<digit_t, P128_1::NWORDS>&);
template void from_montgomery<P128_1>(std::array<digit_t, P128_1::NWORDS>&, const FieldElement<P128_1>&);
