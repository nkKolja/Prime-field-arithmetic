...
template void to_montgomery<P192_1>(FieldElement<P192_1>&, const std::array<digit_t, P192_1::NWORDS>&);
template void from_montgomery<P192_1>(std::array<digit_t, P192_1::NWORDS>&, const FieldElement<P192_1>&);
