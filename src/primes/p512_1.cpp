...
template void to_montgomery<P512_1>(FieldElement<P512_1>&, const std::array<digit_t, P512_1::NWORDS>&);
template void from_montgomery<P512_1>(std::array<digit_t, P512_1::NWORDS>&, const FieldElement<P512_1>&);
